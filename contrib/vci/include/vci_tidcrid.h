 ...
 *
 * vci_tidcrid.h
 *	  Definitsions and Declarations of TIDCRID update list and
...
typedef struct vcis_tidcrid_meta
{
	...
	int32		pgsql_atttypmod;	/* taken from FormData_pg_attribute.atttypmod */
	uint32		num_extents;	/* number of extents (for debug) */
	uint32		num_extents_old;	/* previous number of extents (for recovery) */

	BlockNumber free_page_begin_id; /* page ID of the first free area */
	BlockNumber free_page_begin_id_old; /* previous free_page_begin_id (for recovery) */

	BlockNumber free_page_end_id;	/* page ID of the last free area */
	BlockNumber free_page_end_id_old;	/* previous free_page_end_id (for recovery) */
	...
	BlockNumber num_free_pages; /* number of free DB pages in the listed free area */
	BlockNumber num_free_pages_old; /* for recovery */
	BlockNumber num_free_page_blocks;	/* number of free areas, not number of free DB pages */
