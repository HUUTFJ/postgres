...
typedef struct VciAggStatePerAggData
{
	...
	Datum		(*copy_trans) (Datum, bool, int);	/* transition data copy function */
	FmgrInfo	merge_transfn;	/* function information for merging transition data */
	FmgrInfo	send_transfn;	/* function information for converting transition data to binary */
	FmgrInfo	recv_transfn;	/* function informayion for converting transition data from binary */

	Oid			recv_trans_typioparam;	/* informatinon to be passed as argument when recv_transfn is called */

	FunctionCallInfo merge_trans_fcinfo;	/* datastruct needed to call function via merge_transfn */
	FunctionCallInfo send_trans_fcinfo; /* datastruct needed to call function via send_trans */
	FunctionCallInfo recv_trans_fcinfo; /* datastruct needed to call function via recv_tansfn */
