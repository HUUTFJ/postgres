...
extern bool vci_IsExtendedToMoreThan32Columns(Relation indexRel);
extern void vci_RegisterDroppedAttnum(Relation indexRel, int attnum);
extern void vci_FillDroppedColumnIds(Relation indexRel);
